...
import {} from // isTomorrow,
'../src/utils';
import { toZonedTime } from 'date-fns-tz';
import { isCancellationForbidden } from '../src/utils/reservation.helpers';
...
describe.skip('isCancellationForbidden', () => {
  ...
  it('should return true if hours difference is less than 3', () => {
    // (calculateHoursDiff as jest.Mock).mockReturnValue(1);
    const mockCurrentTime = new Date('2025-03-07T08:00:00Z');
    const mockTrainingTime = new Date('2025-03-07T09:00:00Z');
