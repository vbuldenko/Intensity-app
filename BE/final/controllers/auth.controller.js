...
import { validateName, validateEmail, validatePhone, validatePassword, comparePasswords, validateIdentifier, } from '../utils';
// import { admin } from '../configs/Firebase';
dotenv.config();
const sendAuthentication = async (res, user) => {
    const { accessToken, refreshToken, userData } = await tokenService.generateTokensData(user);
