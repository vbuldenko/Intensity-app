...
import { validateName, validateEmail, validatePassword, comparePasswords, getUserFromRequest, checkAdminRole, } from '../utils';
...
export const updateUser = async (req, res) => {
    ...
    const { updateType, firstName, email, emailConfirm, password, newPassword, newPasswordConfirm, fontSize, } = req.body;
    ...
    switch (updateType) {
        case 'name':
            ...
            const updatedNameUser = await userService.update({ firstName }, userData.id);
        ...
        case 'email':
            ...
            const isEmailPasswordValid = await comparePasswords(password, user.password);
        ...
        case 'fontSize':
            ...
            const updatedSettingsUser = await userService.update({ settings: { ...user.settings, fontSize } }, user.id);
