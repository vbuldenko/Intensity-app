import { cancelNotHeldTrainings, updateReservation, } from '../services/reservation.service';
...
export const reserve = async (req, res) => {
    ...
    const updatedData = await updateReservation(abonementId, trainingId, user.id, updateType);
