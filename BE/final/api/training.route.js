...
router.post(Path.trainings, authMiddleware, catchError(trainingController.create));
router.post(Path.trainingsSchedule, authMiddleware, catchError(trainingController.initializeCurrentWeek));
...
router.delete(Path.training, authMiddleware, catchError(trainingController.remove));
router.delete(Path.trainings, authMiddleware, catchError(trainingController.removeMany));
