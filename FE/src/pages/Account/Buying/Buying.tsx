...
const PaymentDetails = () => {
  return (
    <div className="payment-details card-element">
      ...
      <p className="payment-details__info">ФОП Морозова Анжела Валеріївна</p>
...
const Buying = () => {
  ...
  return (
    <div className="buying">
      ...
      <p className="buying__explanation">
        Щоб записатися на тренування, будь ласка, оплатіть абонемент. Це
        потрібно навіть для пробного тренування. Після оплати надішліть скрін
        квитанції адміністратору і він додасть абонемент до вашого аккаунту.
        Після цього ви зможете бронювати за собою місце на тренуваннях.
      </p>
      <PaymentDetails />
      <p className="buying__explanation">
        Нижче ви знайдете QR-код, який можна відсканувати камерою телефона для
        переходу в застосунок банку для оплати. Вся інформація буде
        підтягуватися автоматично. Єдине, що вам потрібно зробити - вказати суму
        та підтвердити оплату.{" "}
        <span className="text-pink-500">
          {" "}
          Також нижче є кнопка з посиланням, яка виконує ту ж функцію, але вона
          тестова, і може не працювати.
        </span>{" "}
      </p>
